...
- The trip's fixed constraints — check these before suggesting plan changes:
  ...
  - Saturday: Teton hike — Jenny Lake shuttle boat, leaving **8:00 AM**, home ~2:05 — for the 5:30 PM LSU game.
  - Sunday: Yellowstone via the **South Entrance only**, leaving **6:15 AM** with a hard **2:00 PM turnaround at West Thumb** (home ~3:50). Saints kicks off at 11 AM MT while the group is in the park — no cell service, missed live.
