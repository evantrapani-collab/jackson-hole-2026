...
> 📱 **[Open the Trip HQ dashboard →](./index.html)** — the whole trip on one page. Works offline (no cell service in Yellowstone). Add it to your home screen.

| | |
|---|---|
| **Dates** | Sep 17–21, 2026 (Thu–Mon) |
| **Where** | Jackson Hole, WY + Yellowstone & Grand Teton |
| **Group** | 13 guys |
| **House** | Montreux House, Teton Village — check in **4 PM**, out ~10 AM Monday |
| **Money** | ✅ **$784.14/man, all 13 paid.** Lodging + safari + rafting. Nothing left to send |
...
- Airbnb (Montreux House) · flights (AA) · 2 rental SUVs (Hardie + Schick)
- Friday: **Teton Expeditions** safari 8 AM **and** **Jackson Hole Whitewater** raft 1 PM — two outfitters, **one address: 945 W Broadway**. Waivers all signed. **Neither allows alcohol**
- Bear spray: rented at the JAC kiosk on arrival (~$56 total), returned Monday
- Park entry: pay at the gate, ~$140 total. Each $35 is good 7 days — keep the receipt
...
[`/itinerary`](./itinerary/) · [`/dining`](./dining/) *(+ [grocery list](./dining/grocery-list.md))* · [`/logistics`](./logistics/) · [`/packing`](./packing/) · [`/budget`](./budget/) · [`/lodging`](./lodging/) · [`/activities`](./activities/) · [`/maps`](./maps/)
