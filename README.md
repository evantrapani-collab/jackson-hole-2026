...
- [x] ✅ **Cowboy Steakhouse / Snake River Grill** — window closed 8/18 unbooked; house steak nights stand. Walk-in option: [`/dining`](./dining/dining.md#everything-else-triaged-honestly)
- [x] ✅ **Explorer 3rd row — not verifying in advance.** We learn the seat count at the JAC counter Thursday. **If it's a 5-seater** (12 seats for 13), the fix is a third small car at the counter (~$35/person) — a second airport run can't cover the park days, where all 13 move at once. Full contingency: [`/logistics`](./logistics/logistics.md#if-the-explorer-is-a-5-seater--the-counter-plan)
