...
- 🚫 **Bridger Gondola — closed for the season before we arrive.** The mid-mountain lift runs **June 6 – Sept 13, 2026**; we land **Sept 17**. Drewes's Thursday afternoon had "the gondola" as its third stop, and that stop no longer exists — Thursday's 3:00–4:00 block became the grocery/errand hour instead (see `/itinerary`). **The upside: there is now no way to ride the wrong lift, and no risk of paying twice for the same view.** The tram is Sunday's, unambiguously
