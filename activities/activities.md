...
- **Snake River Float Trip** — 10-mile scenic float through the park; moose, beavers, eagles common. Several outfitters: Barker-Ewing, Dave Hansen Whitewater, Mad River Boat Trips
- **Jenny Lake Kayak/Canoe** — rentals available at the marina
- **String Lake** — calm paddling, great for beginners, no motors allowed

### Wildlife Viewing

- **Oxbow Bend** — moose, herons, otters, ducks at dawn/dusk
- **Schwabacher Landing** — the valley's signature sunrise: glassy beaver ponds mirroring the Tetons. Short dirt access road off 89; **don't skip it** — go at first light. ⏰ **It's ~45 min from the house** (the Moose-Wilson shortcut is closed) and **Sunday's sunrise is ~7:07 AM**, so the alarm is **6:00**, not 6:30 — the old docs had this as a 10-minute drive
- **Willow Flats** — moose hotspot near Jackson Lake Lodge
- **Antelope Flats Road** — pronghorn, bison, coyotes
- 🚧 **Moose-Wilson Road — CLOSED Sept 8 – Nov 15, 2026.** The classic moose-and-bear crawl between the Laurance S. Rockefeller Preserve and Moose is shut for NPS Phase II construction (the new Teton Park roundabout). It was on Sunday's sunrise list; **it's cut.** The Teton Village end is still drivable as far as the Preserve via the Granite Canyon entrance, but there's no through-route to Moose — and the knock-on matters more than the lost stop: **every drive from the house into either park now goes the long way, WY-390 → WY-22 → US-26/89/191 through Jackson**, which adds ~10 min each way

### Other

- **Teton Village Aerial Tram** ✅ **— confirmed running, and it's the only lift we get.** Rides to the summit of Rendezvous Mountain (10,450 ft); no hiking required. At the top, **Corbet's Cabin** serves the famous waffles (try the brown sugar & butter) — earn the view, then eat. Walkable from the house, so it's the natural Sunday-afternoon block
  - **2026 season: May 16 – Oct 4, daily 8:30 AM – 5:00 PM.** Sunday Sep 20 is comfortably inside it
  - **~$55/person** for a sightseeing ticket — buy online — ⏰ **was due 9/7 and still unbought**. That's the whole remaining action, and they stay buyable up to Sunday morning; the "is it even open in late September" risk is closed
  - The Saints game ends ~2:15 PM, which leaves a wide window against a 5 PM close
- 🚫 **Bridger Gondola — closed for the season before we arrive.** The mid-mountain lift runs **June 6 – Sept 13, 2026**; we land **Sept 17**. Drewes's Thursday afternoon had "the gondola" as its third stop, and that stop no longer exists — Thursday's 3:00–4:00 block became an errand hour instead — and since 9/9 not even that, because the groceries arrive as a 4 PM delivery (see `/itinerary`). **The upside: there is now no way to ride the wrong lift, and no risk of paying twice for the same view.** The tram is Sunday's, unambiguously
...
|---|---|---|---|
| Grand Prismatic **overlook** | Midway Geyser Basin | ✅ **first stop** | ⚠️ **It's a hike, not a pull-off:** park at the **Fairy Falls trailhead**, walk **0.8 mi each way (1.6 mi RT)** — flat service road, then switchbacks to the platform. **~1 hr for 13 guys.** That lot fills early, which is why we leave at 6:15 |
...
- 🚫 **Lamar Valley** — "America's Serengeti," best wildlife viewing in the lower 48 — but it's the far **northeast** corner, 3+ hrs one-way from our entrance. Not this trip; our wildlife dawn is **Sunday in Grand Teton** (Schwabacher, Oxbow Bend), which is the same show ~45 minutes from the house
...
- 🚫 **Grand Canyon of the Yellowstone** — Upper and Lower Falls; Artist Point is the iconic view. Jeremy calls the waterfalls "can't miss" and he's right — but they're ~1.5 hrs past Old Faithful, and adding them blows the 2:00 PM turnaround with a 5:30 kickoff waiting. The honest trade: the canyon or the LSU game, not both
...
- 🚫 **Town Square Farmers Market** — Saturdays 8 AM–noon into late September, but our Saturday is Yellowstone 6:15 AM → ~3:50 PM, then the LSU game
