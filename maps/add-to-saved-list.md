...
- [ ] [Bridger Gondola](https://www.google.com/maps/search/?api=1&query=Bridger+Gondola%2C+Teton+Village%2C+WY) — 🚫 Season ends Sep 13, 2026 — four days before we land. Thursday's lift stop is void; that hour is slack now (groceries arrive as a 5–7 PM delivery). The TRAM is the one that's running.
