...
- [ ] [Smith's Food and Drug](https://www.google.com/maps/search/?api=1&query=Smith%27s+Food+and+Drug%2C+Jackson%2C+WY) — Backup store for the Friday-evening run (ice, restock). Butcher BACKUP if Albertsons can't cut 13 ribeyes.
- [ ] [Albertsons](https://www.google.com/maps/search/?api=1&query=Albertsons%2C+Jackson%2C+WY) — Friday-evening store run: pick up the 13 bone-in ribeyes here (call the butcher ahead — usually the one carrying Prime), plus ice and the restock.
...
- [ ] [Mural Room (Jackson Lake Lodge)](https://www.google.com/maps/search/?api=1&query=Mural+Room%2C+Jackson+Lake+Lodge%2C+WY) — Big Teton windows; reservations; ~45-60 min north.
- [ ] [Jenny Lake Dining Room](https://www.google.com/maps/search/?api=1&query=Jenny+Lake+Lodge+Dining+Room%2C+Grand+Teton%2C+WY) — Upscale; reservations required; short fall season.
- [ ] [Jackson Hole Playhouse](https://www.google.com/maps/search/?api=1&query=Jackson+Hole+Playhouse%2C+Jackson%2C+WY) — Dinner + live Western musical; whole evening.
- [ ] [Pica's Mexican Taqueria](https://www.google.com/maps/search/?api=1&query=Pica%27s+Mexican+Taqueria%2C+Jackson%2C+WY) — Cheap, legendary, cash only.
- [ ] [Snake River Grill](https://www.google.com/maps/search/?api=1&query=Snake+River+Grill%2C+Jackson%2C+WY) — Upscale, on the square.
...
- [ ] [Creekside Market & Deli](https://www.google.com/maps/search/?api=1&query=Creekside+Market+and+Deli%2C+545+N+Cache+St%2C+Jackson%2C+WY+83001) — SATURDAY LUNCH + the burrito batch, pre-ordered and grabbed on the way north. 545 N Cache IS US-26/89/191, so it is on the route, not a detour. DELI HOURS 6 AM-5 PM (the 8 PM on Google is the liquor store) - which is why pickup is Saturday morning, not the Friday-evening run. Order: 307-733-7926 / deli@creeksidejh.com. ~10-min stop.
...
- [ ] [Jackson Hole Aerial Tram](https://www.google.com/maps/search/?api=1&query=Jackson+Hole+Aerial+Tram%2C+Teton+Village%2C+WY) — ✅ Running May 16-Oct 4, 2026, 8:30-5. Rendezvous Mtn summit (10,450 ft); Corbet's waffles up top. ~$55/person; tickets were due 9/7 and are still unbought, but stay buyable up to Sunday. Walkable from the house.
- [ ] [Bridger Gondola](https://www.google.com/maps/search/?api=1&query=Bridger+Gondola%2C+Teton+Village%2C+WY) — 🚫 Season ends Sep 13, 2026 — four days before we land. Thursday's lift stop is void; that hour is slack now (groceries arrive as a 4 PM delivery). The TRAM is the one that's running.
