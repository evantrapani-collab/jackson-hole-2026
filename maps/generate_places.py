...
PLACES = [
    ...
    ("Jackson Hole Airport (JAC)", "Lodging & Logistics", "Thu / Mon", "Jackson Hole Airport, WY", True, "Fly in 10:19 AM Thu; depart 11:47 AM Mon. Rental pickup — AND bear-spray rental at the Bear Aware kiosk by baggage claim #3. ~30-35 min to the house (Moose-Wilson shortcut is closed)."),
    ...
    ("The Bunnery", "Food & Drink", "Fri AM", "The Bunnery, Jackson, WY", False, "Pastries/coffee on the way to the 8 AM safari."),
    ("Cowboy Coffee — DRIVE-THRU", "Food & Drink", "Fri AM", "1007 S US-89, Jackson, WY 83001", False, "THE Friday stop: opens 6 AM, ~2 min from the boathouse, on the route in from Teton Village. Leave the house 6:45."),
    ...
    ("Dornan's Pizza Pasta Co.", "Food & Drink", "Thu", "Dornan's Pizza Pasta Co, Moose, WY", False, "Deck pizza with full Teton views. Open daily 11:30 AM-7 PM year-round. ~12 min from JAC — Thursday's arrival lunch. Roundabout work at the Moose junction can add up to 20 min."),
    ...
    ("Grand Teton — Moose / Visitor Center", "Grand Teton NP", "Fri/Sat/Sun", "Craig Thomas Discovery and Visitor Center, Moose, WY", False, "South park gateway; near Dornan's."),
    ("Jenny Lake", "Grand Teton NP", "Sat", "Jenny Lake, Grand Teton National Park, WY", True, "East Boat Dock — shuttle runs 9 AM-5 PM through Sep 30, every 10-15 min, no reservation, $18/adult round trip."),
    ("Hidden Falls & Inspiration Point", "Grand Teton NP", "Sat", "Inspiration Point, Grand Teton National Park, WY", False, "Waterfall + panorama off the West Dock — first stretch of Saturday's hike."),
    ("Cascade Canyon Trailhead", "Grand Teton NP", "Sat", "Cascade Canyon Trailhead, Grand Teton, WY", False, "Hike in to the forks and back (~9 mi RT from the West Dock) — turn around there, Lake Solitude is a full day on its own."),
    ...
    ("Oxbow Bend", "Grand Teton NP", "🚫 Cut this trip", "Oxbow Bend, Grand Teton National Park, WY", False, "Moose/elk + classic Teton reflection. Cut — Sunday became the Yellowstone day."),
    ("Schwabacher Landing", "Grand Teton NP", "🚫 Cut this trip", "Schwabacher Landing, Grand Teton National Park, WY", False, "Beaver ponds mirroring the Tetons. Cut — Sunday became the Yellowstone day."),
    ("Mormon Row Historic District", "Grand Teton NP", "🚫 Cut this trip", "Mormon Row Historic District, WY", False, "Barns + bison against the Tetons. Cut — Sunday became the Yellowstone day."),
    ("Antelope Flats Road", "Grand Teton NP", "🚫 Cut this trip", "Antelope Flats Road, Grand Teton, WY", False, "Pronghorn, bison, coyotes. Cut — Sunday became the Yellowstone day."),
    ...
    ("Bridger Gondola", "Grand Teton NP", "🚫 CLOSED Sep 13", "Bridger Gondola, Teton Village, WY", False, "🚫 Season ends Sep 13, 2026 — four days before we land. Thursday's lift stop is void; that hour is slack now (groceries arrive as a 5–7 PM delivery). The TRAM is the one that's running."),
    ...
    ("Yellowstone South Entrance", "Yellowstone NP", "Sun", "Yellowstone South Entrance, WY", False, "Our gate — ~1 hr 30 from the house, not 1 hr. Pay $35/vehicle here (7-day pass). Unaffected by the 2026 north-side bridge work."),
    ("Old Faithful", "Yellowstone NP", "Sun", "Old Faithful, Yellowstone National Park, WY", True, "Check predicted eruption (~90-min cycle)."),
    ("Grand Prismatic Spring", "Yellowstone NP", "Sun — skippable", "Grand Prismatic Spring, Yellowstone, WY", True, "The boardwalk. If you do the overlook, you can skip going close to it."),
    ("Fairy Falls Trailhead (overlook)", "Yellowstone NP", "Sun — 1st stop", "Fairy Falls Trailhead, Yellowstone, WY", False, "Grand Prismatic overlook — do this FIRST, then skip the boardwalk below. It's a HIKE: 0.8 mi each way, ~1 hr for 13 guys. Small lot, fills early."),
    ("West Thumb Geyser Basin", "Yellowstone NP", "Sun — TURNAROUND", "West Thumb Geyser Basin, Yellowstone, WY", True, "Last stop + cooler lunch at the picnic tables. HARD RULE: wheels rolling south by 2:00 PM. Saints game (11 AM MT) happens while you're in the park — no cell service, no live coverage."),
    ("Emerald Spring (Norris)", "Yellowstone NP", "🚫 Next trip", "Emerald Spring, Norris Geyser Basin, Yellowstone, WY", False, "Jeremy's favorite pool — but it's Norris, well past our 2:00 PM West Thumb turnaround."),
    ...
    ("Grand Canyon of the Yellowstone", "Yellowstone NP", "🚫 Next trip", "Grand Canyon of the Yellowstone, WY", True, "Artist Point is the iconic view. Adding it blows the 2:00 PM West Thumb turnaround."),
    ...
    ("Yellowstone Lake", "Yellowstone NP", "Sun (en route)", "Yellowstone Lake, WY", False, "Osprey, eagles, cutthroat trout; you drive its shore between West Thumb and the South Entrance."),
