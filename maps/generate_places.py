...
PLACES = [
    ...
    ("Cowboy Coffee Co.", "Food & Drink", "Fri AM", "Cowboy Coffee Co, Jackson, WY", False, "The must-do coffee stop on the square; ~5 min from the boathouse — to-go, wheels up ~7 AM."),
