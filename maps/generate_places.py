...
PLACES = [
    ...
    ("Oxbow Bend", "Grand Teton NP", "Sun drive", "Oxbow Bend, Grand Teton National Park, WY", False, "Moose/elk + classic Teton reflection."),
    ("Schwabacher Landing", "Grand Teton NP", "Sun drive", "Schwabacher Landing, Grand Teton National Park, WY", False, "Sunday's first stop, ~7:30. ~45 min from the house (Moose-Wilson is closed). Last mile is dirt."),
    ("Mormon Row Historic District", "Grand Teton NP", "Sun drive", "Mormon Row Historic District, WY", False, "Barns + bison against the Tetons."),
    ("Antelope Flats Road", "Grand Teton NP", "Sun drive", "Antelope Flats Road, Grand Teton, WY", False, "Pronghorn, bison, coyotes."),
    ...
    ("Yellowstone South Entrance", "Yellowstone NP", "Sat", "Yellowstone South Entrance, WY", False, "Our gate — ~1 hr 30 from the house, not 1 hr. Pay $35/vehicle here (7-day pass). Unaffected by the 2026 north-side bridge work."),
    ...
    ("Fairy Falls Trailhead (overlook)", "Yellowstone NP", "Sat — 1st stop", "Fairy Falls Trailhead, Yellowstone, WY", False, "Grand Prismatic overlook — do this FIRST, then skip the boardwalk below. It's a HIKE: 0.8 mi each way, ~1 hr for 13 guys. Small lot, fills early."),
    ("West Thumb Geyser Basin", "Yellowstone NP", "Sat — TURNAROUND", "West Thumb Geyser Basin, Yellowstone, WY", True, "Last stop + cooler lunch at the picnic tables. HARD RULE: wheels rolling south by 2:00 PM — it's ~1 hr 50 back to the house and kickoff is 5:30."),
