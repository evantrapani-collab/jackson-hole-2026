...
PLACES = [
    ...
    ("Cutty's Bar & Grill", "Food & Drink", "Sun", "Cutty's Bar & Grill, Wilson, WY", True, "Sunday Saints-game option (Hwy 22). Was the Friday lunch pick — now a ~10-min detour each way from the boathouse."),
    ...
    ("Sidewinders Tavern", "Food & Drink", "Fri lunch / Sun game", "Sidewinders Tavern, Jackson, WY", False, "Sports tavern at 945 W Broadway — next door to the Friday boathouse, so it's the free lunch-hour recon for the Sunday game (Jeremy rec)."),
    ...
    ("Schwabacher Landing", "Grand Teton NP", "Sun sunrise", "Schwabacher Landing, Grand Teton National Park, WY", False, "The signature sunrise. ~45 min from the house (Moose-Wilson is closed); sunrise ~7:07, so LEAVE AT 6:00. Last mile is dirt."),
    ...
    ("Jackson Hole Aerial Tram", "Grand Teton NP", "Sun PM", "Jackson Hole Aerial Tram, Teton Village, WY", False, "✅ Running May 16-Oct 4, 2026, 8:30-5. Rendezvous Mtn summit (10,450 ft); Corbet's waffles up top. ~$55/person, buy online by 9/7. Walkable from the house."),
