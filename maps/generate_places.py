...
PLACES = [
    ...
    ("Norris Geyser Basin", "Yellowstone NP", "If time", "Norris Geyser Basin, Yellowstone, WY", True, "Hottest, most active; Steamboat Geyser."),
    ("Mammoth Hot Springs", "Yellowstone NP", "If time", "Mammoth Hot Springs, Yellowstone, WY", True, "Travertine terraces (far north)."),
    ("Artists' Paintpots", "Yellowstone NP", "If time", "Artists Paintpots, Yellowstone, WY", False, "Accessible, less crowded."),
    ("Grand Canyon of the Yellowstone", "Yellowstone NP", "If time", "Grand Canyon of the Yellowstone, WY", True, "Artist Point is the iconic view."),
    ("Lamar Valley", "Yellowstone NP", "If time", "Lamar Valley, Yellowstone National Park, WY", False, "'America's Serengeti'; wolves, bison (far NE)."),
    ("Hayden Valley", "Yellowstone NP", "If time", "Hayden Valley, Yellowstone National Park, WY", False, "Bison, grizzlies; closer to Canyon."),
    ("Yellowstone Lake", "Yellowstone NP", "If time", "Yellowstone Lake, WY", False, "Osprey, eagles, cutthroat trout."),
    ("Mount Washburn", "Yellowstone NP", "If time", "Mount Washburn, Yellowstone, WY", False, "Lookout tower; 360° views; grizzlies."),
    ("Boiling River", "Yellowstone NP", "Seasonal", "Boiling River, Yellowstone National Park, WY", False, "Hot springs meet the Gardner; verify it's open."),
